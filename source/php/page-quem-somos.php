...
<main>
  <section>
    <div class="bannerDefault bannerQuemSomos">
      <div class="container">
        <div class="row no-gutters">
          <div class="col-12 col-md-6">
            <h2 class="animation-element slide-aparece">Conheça a <br> nossa História</h2>
            <div class="subtitle animation-element slide-aparece"> Se a primeira impressão é a que fica, é melhor contar com a gente. Transformar ideias em realidade. Esse é o negócio da Rossini Comunicação Inteligente.</div>
            <div class="btn_gradient btnDefault col-12 animation-element slide-aparece">
              <a href="#sobre-nos"><?php echo $arrow; ?></a>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="imagem animation-element slide-aparece">
              <div class="imagemBanner animation-element slide-top">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/dist/img/banner_quem_somos_imagem.png" alt="" class="img-fluid">
              </div>
  ...
  <section>
    <div class="aboutUs aboutPage">
      <div class="container">
        <div class="row no-guttes">
          <div class="col-12 col-lg-6">
            <h2 class="animation-element slide-aparece" id="sobre-nos">Quem <br>Somos</h2>
            <div class="texto animation-element slide-aparece">
              ...
              <p>Antes de mais nada, vamos falar de experiência. Estamos no mercado desde 1998 e somos referência em comunicação visual.</p>
            </div>
          </div>
          <div class="col-12 col-lg-6">
            <div class="imagem animation-element slide-aparece">
          ...
          <div class="col-12 col-lg-6 columnHideMobile">
            <div class="imagem animation-element slide-aparece">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/dist/img/rossini_quem_somos_2.png" alt="" class="img-fluid">
            </div>
          </div>
          ...
          <div class="col-12 col-lg-6">
            <div class="texto">
              ...
              <p> Nosso trabalho tem como base a inovação. A busca por novos materiais, formatos e métodos.</p>

              <p>Primeiramente pela percepção do que o cliente espera de nós.</p>

              <p>Entender o seu negócio é um passo fundamental do nosso processo.</p>

              <p>Dessa forma, com conhecimento sobre a situação atual e objetivos futuros, é possível desenvolver de forma assertiva.</p>

              <p> Como resultado, entregamos ao cliente mais do que ele imaginava.</p>

              <p> Tanto em cores, texturas e iluminação quanto em formato e funcionalidade.</p>

              <p> De maneira idêntica, compreendemos o valor do tempo para uma empresa. </p>
            </div>
          </div>

          <div class="col-12 col-lg-6">
            <div class="texto">
              <p> Isso significa que temos comprometimento máximo com cada prazo estabelecido.</p>

              <p> Rossini Comunicação Inteligente: segmentos</p>

              <p>Em primeiro lugar é preciso entender que toda empresa, não importa o seu segmento, precisa de comunicação visual.</p>

              <p> Nesse sentido, não atendemos apenas estabelecimentos comerciais.</p>

              <p> Prestadores de serviço, clínicas, indústrias e muitas outras empresas compõem o nosso portfólio.</p>

              <p>Do mesmo modo, é preciso desmistificar a comunicação visual.</p>

              <p>Empresas de pequeno e médio porte podem contar com a nossa parceria.</p>
          ...
          <div class="col-12 col-lg-6">
            <div class="imagem animation-element slide-aparece">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/dist/img/rossini_quem_somos.png" alt="" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="serviceText">
      <div class="container">
        <div class="row no-gutters">
          ...
          <div class="col-12 col-md-6">
            <div class="texto animation-element slide-aparece">
              <p> Uma bela fachada termo moldada ou um belo display de acrílico para produtos.</p>

              <p> São investimentos que o diferenciam dos concorrentes. Sobretudo em mercados altamente competitivos.</p>

              <p> Em outras palavras, a Rossini Comunicação Inteligente tem o produto certo para o seu negócio.</p>

              <p> Entre em contato conosco e descubra um novo mundo de comunicação visual.</p>

              <p> Um mundo onde suas ideias ganham vida! </p>
            </div>
          </div>
        </div>
      </div>
...
jQuery("#sobreFooter").addClass("activeMenuFooter");
</script>